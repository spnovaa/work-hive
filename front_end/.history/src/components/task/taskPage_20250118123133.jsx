...
const TaskPage = () => {
  ...
  const handleOpenModal = (task = null) => {
    setSelectedTask(task); // If a task is passed, set it for editing; otherwise, it's a new task
    setModalOpen(true);
  };
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="space-y-4">
        {tasks.map((task) => (
          <div
            ...
            onClick={() => handleOpenModal(task)} // Open modal with the selected task
          >
            <div>
      ...
      <TaskModal
        ...
        refreshTasks={() => window.location.reload()} // Temporary refresh mechanism
      />
    </div>
  );
};
