...
const ProfileDropdown  = ({  onBackgroundChange }) => {
  ...
  className="absolute top-0 left-0 z-20 bg-white rounded-lg shadow-lg w-full p-4"
>
  <div
  ...
  {/* Logout */}
  <div
    className="contents items-center justify-between p-2 cursor-pointer hover:bg-gray-100 rounded"
