...
const ProfileDropdown  = ({  onBackgroundChange }) => {
  ...
  const backgrounds = [
    ...
    // Additional gradients and colors
    ...
    // Subtle backgrounds for minimalistic designs
    'bg-gray-50', // Almost white
    'bg-gray-100',
    'bg-gradient-to-r from-gray-300 via-gray-100 to-gray-200',
  ];
