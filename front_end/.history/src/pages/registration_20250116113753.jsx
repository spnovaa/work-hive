  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white p-8 rounded-3xl shadow-xl border border-gray-200">
        <div className="text-center mb-6 flex items-center justify-center space-x-reverse space-x-3">
          <img src="../assets/logo.png" alt="میزیتو" className="h-12" />
          <h1 className="text-xl font-bold text-gray-700">میزیتو</h1>
        </div>
